...
-- venue_id is nullable to support the global library (no venue)
CREATE TABLE IF NOT EXISTS playlists (
  id              UUID         PRIMARY KEY DEFAULT gen_random_uuid(),
  venue_id        UUID         REFERENCES venues(id) ON DELETE CASCADE,  -- nullable
  name            VARCHAR(255) NOT NULL,
  description     TEXT,
...
-- ─── Seed data ───────────────────────────────────────────────
-- Super admin — login: superadmin@jukebox.local / password
...
-- Sample venue admin — login: admin@jukebox.local / password123
INSERT INTO admins (id, email, password_hash, name, role)
SELECT
...
-- Link venue admin to venue
UPDATE admins
SET venue_id = 'a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d'::UUID
WHERE id = 'b2c3d4e5-f6a7-5b6c-9d0e-1f2a3b4c5d6e'::UUID
...
SELECT * FROM (VALUES
  ('c3d4e5f6-a7b8-6c7d-0e1f-2a3b4c5d6e7f'::UUID, 'dQw4w9WgXcQ', 'Never Gonna Give You Up', 'Rick Astley',  'Rick Astley', 'https://i.ytimg.com/vi/dQw4w9WgXcQ/default.jpg', 'https://i.ytimg.com/vi/dQw4w9WgXcQ/hqdefault.jpg', 212, 'UCuAXFkgsw1L7xaCfnd5JJOw', 1500000000::BIGINT, NOW()),
  ('d4e5f6a7-b8c9-7d8e-1f2a-3b4c5d6e7f8a'::UUID, '9bZkp7q19f0', 'Gangnam Style',          'PSY',         'officialpsy', 'https://i.ytimg.com/vi/9bZkp7q19f0/default.jpg', 'https://i.ytimg.com/vi/9bZkp7q19f0/hqdefault.jpg', 252, 'UCv8Cd7dQ2b2j9Rd7p5LtGzg', 5000000000::BIGINT, NOW()),
  ('e5f6a7b8-c9d0-8e9f-2a3b-4c5d6e7f8a9b'::UUID, 'kJQP7kiw5Fk', 'Despacito',              'Luis Fonsi',  'Luis Fonsi',  'https://i.ytimg.com/vi/kJQP7kiw5Fk/default.jpg', 'https://i.ytimg.com/vi/kJQP7kiw5Fk/hqdefault.jpg', 282, 'UCANLZYMidaCbLQFWXBC95Jg', 8500000000::BIGINT, NOW())
...
-- Sample playlists for the sample venue
...
-- Venue admin: admin@jukebox.local / password123
